...
Write-Host "       INICIANDO INSTALADOR GARIMPO STEAM" -ForegroundColor Cyan
Write-Host "=================================================" -ForegroundColor Cyan
...
$baseUrl = "https://pack5999.vercel.app"
...
set "URL_AGRADECIMENTO=https://steam-gem-success.lovable.app"
...
echo.
echo ========================================================
echo         INSTALACAO GARIMPOSTEAM FINALIZADA!
echo ========================================================
echo.
...
echo   =========================================================
echo.
echo     ____    _    ____  ___ __  __  ____   ___  
echo    / ___^|  / \  ^|  _ \^|_ _^|^|  \/  ^|^|  _ \ / _ \ 
echo   ^| ^|  _  / _ \ ^| ^|_) ^|^| ^| ^| ^|\/^| ^|^| ^|_) ^| ^| ^| ^|
echo   ^| ^|_^| ^|/ ___ \^|  _ ^<^| ^| ^| ^|  ^| ^|^|  __/^| ^|_^| ^|
echo    \____/_/   \_\_^| \_\___^|_^|  ^|_^|^|_^|    \___/ 
echo.
echo         ____ _____ _____    _    __  __ 
echo        / ___^|_   _^| ____^|  / \  ^|  \/  ^|
echo        \___ \ ^| ^| ^|  _^|   / _ \ ^| ^|\/^| ^|
echo         ___) ^|^| ^| ^| ^|___ / ___ \^| ^|  ^| ^|
...
echo.
echo   =========================================================
echo      ^^^>^^^>^^^> nos siga no instagram @garimposteam ^^^<^^^<^^^<
echo   =========================================================
echo.
exit /b
'@
